                    ...
                    <header className="h-[64px] flex items-center justify-between px-6 bg-white backdrop-blur-xl border-b border-gray-100/80 sticky top-0 z-[100]">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="relative">
                                <button id="notif-bell" onClick={() => setShowNotifMenu(!showNotifMenu)} className="p-2.5 rounded-xl text-gray-400 hover:text-gray-600 hover:bg-gray-100 transition-all relative">
                                    <Bell size={20} />
