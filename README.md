...
Datavera (v0.1.0) is a high-performance data science dashboard application built with **FastAPI**, **React**, and **Tailwind CSS**. It features robust Role-Based Access Control (RBAC), real-time WebSocket communication, and a modern, glassmorphic UI.
